...
// TODO Fix: Text becomes unreadable in system dark mode and app light theme
@Composable
fun ArtHouseTheme(
    ...
    val darkTheme = ThemeManager.artHouseTheme == Theme.DARK
    Log.i("ArtHouseTheme", theme.name)
